          ...
          <div class="row">
            ...
            <div class="column">
              <div class="form-group">
                ...
                <input type="text" class="form-control cpf" id="cpf" name="cpf" placeholder="Digite o cpf">
              </div>
            </div>
            <div class="column">
              <div class="form-group">
            ...
            <div class="column">
              <div class="form-group">
                ...
                <input type="text" class="form-control smartphone_ddd_br" id="phone" name="phone" placeholder="Digite o phone">
              </div>
            </div>
        </form>
      </div>
